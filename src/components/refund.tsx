      ...
      <section className="bg-fitlytic-black text-white py-16">
        <div className="fitlytic-container">
          <div className="max-w-3xl">
            <h1 className="fitlytic-heading text-4xl md:text-5xl mb-4">Refund Policy</h1>
      ...
      <section className="fitlytic-section bg-white">
        <div className="fitlytic-container">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">30-Day Money-Back Guarantee</h2>
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">Subscription Refunds</h2>
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">Digital Product Refunds</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">How to Request a Refund</h2>
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">Non-Refundable Items</h2>
            <ul className="text-gray-700 mb-6 space-y-2">
            ...
            <h2 className="fitlytic-heading text-2xl mb-4">Contact Us for Refunds</h2>
            <p className="text-gray-700 mb-6">
